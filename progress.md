...
- rock_neo main: 475 functions in asm/rock_neo/nonmatchings (385 still active
...
- rock_neo main: 99 (verified: 99 = .text function symbols across
  build/src/rock_neo/*.c.o minus active INCLUDE_ASM stubs, with the
  full-binary sha1 OK)
- Volume: ~1240 of ~31,300 mapped instructions (~4.0%)
  ...
  - scene: func_8001D878, func_8001DEDC, func_8001F820, func_8001D974,
    func_8001DDC0, func_8001D854, func_8001DEE4, func_8001E7E4, func_8001E810,
  ...
  - main: func_800131FC, func_8001326C, func_80012FA4, func_80012FC8,
    vsync_cb, func_80012F78, func_80012E98
...
## Last verified build
- 2026-07-04 (late night) — `make CPP=cpp check_rock_neo_only` OK after the
  17-function batch; mutation test performed (broke Sce_flag_test mask
  constant, check failed; restored, OK)

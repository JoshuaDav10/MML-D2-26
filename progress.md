...
- rock_neo main: **486** functions in linked object code (`tools/census.py
  --matched`; see `notes/COUNTS.md`). **476** have splat asm under
...
- rock_neo main: **282** (AUTHORITATIVE — tools/audit_count.sh: clean rm -rf build,
  hash OK, raw cmp byte-identical, census 282. 486 total, 204 active stubs.
  Denominators (name which — see notes/WORK_MAP.md): 282/486 = 58.0% C-slice ·

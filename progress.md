...
- rock_neo main: 475 functions in asm/rock_neo/nonmatchings (379 still active
...
- rock_neo main: 105 (verified: 105 = .text function symbols across
  build/src/rock_neo/*.c.o minus active INCLUDE_ASM stubs, with the
  full-binary sha1 OK)
- Volume: ~1310 of ~31,300 mapped instructions (~4.2%)
  - moji: func_800542FC + accessor family func_80054310..func_800543F8, func_80054BAC,
    ...
    func_80054BB4, func_80055CC4, func_80056148
...
- 2026-07-04/05 (overnight) — `make CPP=cpp check_rock_neo_only` OK after the
  ...
  advance, check failed; restored, OK)

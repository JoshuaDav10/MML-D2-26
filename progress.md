...
- rock_neo main: 475 functions in asm/rock_neo/nonmatchings (367 still active
...
- rock_neo main: 117 (verified: 117 = .text function symbols across
  build/src/rock_neo/*.c.o minus active INCLUDE_ASM stubs, with the
  full-binary sha1 OK)
- Volume: ~1490 of ~31,300 mapped instructions (~4.8%)
  ...
  - sound: func_80019F94, func_8001B2F0, func_8001997C, func_8001B314,
    func_80019A70, func_80019AE0, func_80019AA4
...
- 2026-07-04/05 (overnight) — `make CPP=cpp check_rock_neo_only` OK after the
  6-function batch; mutation tests performed (func_80056148, func_80057DB8,
  func_8001FB54 — each broken constant failed the check; restored, OK)

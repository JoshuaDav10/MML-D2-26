...
|---|---|---|---|
| **ENGINE** | `ROCK_NEO.EXE`. Resident in RAM always; every stage calls into it. | **1,119** | **306** (27.3%) |
| **STAGES** | 37 code archives (168 more are asset-only). 10,107 copies of 7,064 unique bodies. | **7,064** | **12** (0.2%) |
| **WHOLE GAME** | | **8,183** | **318** (3.9%) |
...
|---|---|---|---|---|
| `MATCHED` | engine | real C, recompiles to identical bytes. **The deliverable.** | **318** | — |
| `STUB` | engine | in a C file but body is still `INCLUDE_ASM`. Bookkeeping only. | 199 | — |

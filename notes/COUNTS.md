...
|---|---|---|
| `F .text` in all rock_neo `.o` | **488** | Functions currently split into C TUs. **NOT the mission denominator** — see below. |
...
| Matched (real C in tree) | **282** | `488 − 206`. Authoritative; hash OK + raw cmp byte-identical. |

/* func_80063334 — 180 asm insns
 * TU: src/rock_neo/debug.c
 * asm: asm/rock_neo/nonmatchings/debug/func_80063334.s
...
extern s32 D_8008DCF4;
extern ? D_8008DCF8;
extern s8 D_800987D4;
extern ? Player_work;

s32 func_80063334(void *arg0) {
    ? *var_a1;
    ? *var_s1;
    s16 temp_v1_2;
    s32 *var_v1;
    ...
    if (temp_v1 != 1) {
        if (temp_v1 < 2) {
            ...
            temp_a1->unk6 = (s16) (s8) Player_work.unk16A;
            temp_v0 = (s32) ((s8) Player_work.unk16A << 0x10) >> 0xC;
            *(&D_8008DCF4 + temp_v0) = *(&D_8008DCF4 + temp_v0) | 0x40000;
            goto block_10;
        }
...
block_10:
            ...
            goto block_14;
        case 3:                                     /* switch 1 */
            temp_v1_2 = arg0->unk26;
            if (temp_v1_2 != (s8) Player_work.unk16A) {
                Player_work.unk16A = (u8) temp_v1_2;
...
block_14:
        ...
        if (arg0->unkC == 2) {
            ...
            case 0x2000:                            /* switch 2 */
                ...
                *(&D_8008DCF4 + temp_v1_4) = *(&D_8008DCF4 + temp_v1_4) & 0xFFFBFFFF;
                temp_v1_5 = temp_a1->unk4 * 0x10;
                *(&D_8008DCF4 + temp_v1_5) = *(&D_8008DCF4 + temp_v1_5) | 0x40000;
                temp_a1->unk6 = (s16) (s8) (u8) temp_a1->unk4;
                break;
            }
            arg0->unkD = (s8) (u8) temp_a1->unk4;
            *(&D_8008DCF8 + (temp_a1->unk4 * 0x10)) = 0x3E;
        }
        var_s1 = &D_8008DCF8;
        var_s0 = 0;
        var_a1 = &D_8008DCF8;
